<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Phukientheoloai.aspx.cs" Inherits="DaoHoangSon_QLBanPKMT.Phukientheoloai" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="dtloai" runat="server" RepeatColumns="4">
        <ItemTemplate>
